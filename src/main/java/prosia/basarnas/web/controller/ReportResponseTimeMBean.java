...
public @Data
class ReportResponseTimeMBean extends AbstractManagedBean {
    ...
    public ReportResponseTimeMBean() {
        try {
    ...
    public void reportPrint() throws ParseException {
        try {
            ...
            DateFormat now = new SimpleDateFormat("dd-MM-yy HH:mm");
            String user = getCurrentUser().getParty().getFullName();
            HashMap hm = new HashMap();
//            String jrxml = "/report/report_jasper/Report_ResponseTime.jrxml";
            String jrxml = File.separator + "report" + File.separator + "report_jasper" + File.separator + "Report_ResponseTime.jrxml";
...
//parameter atau field yang akan dijadikan filter
            ...
            hm.put("INCIDENTTYPES", INCIDENTTYPES);
            ...
            response.setHeader("Content-Disposition", "inline; filename=\"ReportResponseTime.pdf\"");
