...
public @Data
class ReportGrafikJumlahInsidenMBean extends AbstractManagedBean {
    ...
    public ReportGrafikJumlahInsidenMBean() {
        try {
    ...
    public void reportPrint() throws ParseException {
        try {
           ...
           // String jrxml = "/report/report_jasper/Report_grafik_insiden.jrxml";
            String jrxml = File.separator + "report" + File.separator + "report_jasper" + File.separator + "Report_grafik_insiden.jrxml";
