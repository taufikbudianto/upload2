...
@Entity
@Data
@Table(name = "dfc_worksheet3")
public class DriftCalcWorksheet3 extends AbstractAuditingEntity implements Serializable, Cloneable {
    ...
    @Column(name = "terraincorrectionfactor")
