 ...
 * @author Aris
 */
public class TSRPattern extends GSearchPattern{
    public String trackSpacing;
    public String searchLeg;
    public String heading;
    private static final String DESC_TRACK_SPACING = "Track_Spacing";
    ...
    public TSRPattern(String name, GLatLng start, String trackSpacing, String searchLeg, String heading, GLatLng pivot, Object browser, List<GLatLng> l, Color color, String hexColor, String parrentID) {
        ...
        this.pivot = pivot;
        ID = ++AUTO_INCEREMENT;
        setType(GSearchPattern.TSR);
        //setIcon(NavigatorIconCollection.TSR_ICON_32);
        setConstructorType(ConstructorType.LOAD_FROM_DATABASE);
    }
    
    
    public TSRPattern(String name, GLatLng start, String trackSpacing, String searchLeg, String heading, Object browser, Color color, String hexColor, String parrentID) {
    ...
    public synchronized String createDescription() {
        ...
        String des = new StringBuilder(DESC_OPEN)
                ...
                .append(this.getTraceSpacing()).append(DESC_FIELD_SEPARATOR)
                ...
                .append(DESC_BEGIN_VALUE_COUPLE).append(pivot.getLat()).append(",").append(pivot.getLng()).append(DESC_END_VALUE_COUPLE)
                .append(DESC_FIELD_SEPARATOR)
                .append(DESC_START).append(" ").append(DESC_VALUE_SEPARATOR).append(" ").append(DESC_BEGIN_VALUE_COUPLE)
                .append(startPosition.getLat()).append(",").append(startPosition.getLng())
                .append(DESC_END_VALUE_COUPLE).append(DESC_FIELD_SEPARATOR)
                .append(DESC_HEX_COLOR).append(" ").append(DESC_VALUE_SEPARATOR).append(" ").append(this.getHexColor()).append(DESC_FIELD_SEPARATOR)
    ...
    public static void main(String[] args) {
        String description = DESC_OPEN
                + DESC_TRACK_SPACING + " " + DESC_VALUE_SEPARATOR + " " + 1 + DESC_FIELD_SEPARATOR
                + DESC_SEARCH_LEG + " " + DESC_VALUE_SEPARATOR + " " + 10 + DESC_FIELD_SEPARATOR
                + DESC_HEADING + " " + DESC_VALUE_SEPARATOR + " " + 30 + DESC_FIELD_SEPARATOR
                + DESC_PIVOT + " " + DESC_VALUE_SEPARATOR + " " + DESC_BEGIN_VALUE_COUPLE + 0.982382 + "," + 0.98293233 + DESC_END_VALUE_COUPLE + DESC_FIELD_SEPARATOR
                + DESC_START + " " + DESC_VALUE_SEPARATOR + " " + DESC_BEGIN_VALUE_COUPLE + 9.092932 + "," + 0.9329323 + DESC_END_VALUE_COUPLE
                + DESC_CLOSE;
    ...
    public static TSRPattern createGSearchPatternFromSearchPatern(IncidentSearchPattern pattern, List<GLatLng> gLatLngs, Object browser) {
        ...
        TSRPattern tsrPattern = new TSRPattern(name, start, trackSpacing, searchLeg, heading, pivot, browser, gLatLngs, color, hexColor, parrentID);
        tsrPattern.setSearchPatternID(pattern.getSearchPatternId());
        return tsrPattern;
    }
    ...
    public String createConcurrent() {
        return "{object:"+ toJSON() +", gen:generateTSRPattern}";
    }
