...
DriftCalculation.prototype.draw = function(){
    var me = this;
    if(this.drawLine){
        this.lkpMarker = CustomLabelMarker(DRIFTCALCULATION_LKP_DEFAULT_SYMBOL_GIS, this.lkp, "<h5>LKP</h5>", new GSize(-5,-5));
        ...
        this.lkpToDatumLine = new GPolyline([this.lkp , this.datum], "#FF0000", 2, 1);
        map.addOverlay(this.lkpToDatumLine);
        this.lkpToleftLeeway = new BDCCPolyline([this.lkp , this.leftLeeway], "#FF0000", 2, 1, " line from LKP to Right Leeway", "dash")
        map.addOverlay(this.lkpToleftLeeway);
        this.lkpToRigthLeeway = new BDCCPolyline([this.lkp , this.rightLeeway], "#FF0000", 2, 1, " line from LKP to Left Leeway", "dash");
    ...
    if(this.drawLine){
        this.lineLeftToRightLeeway = new BDCCPolyline([this.leftLeeway, this.rightLeeway], "#FFFFFF", 2, 1, " line from Left leeway to right leeway", "dash");
    ...
    map.setCenter(this.datum, map.getBoundsZoomLevel(this.searchArea.getBounds()));    
}
