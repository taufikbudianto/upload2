...
public class GTrapeziumSearchArea extends GPoly<Object> {
    ...
    public GTrapeziumSearchArea(Object browser, String id, GLatLng smallRoundPivot, GLatLng largeRoundPivot, 
            double smallRoundRadius, double largeRoundRadius, double min, double max, double width, 
            double trackSpacing, double heading, LatLng startTrapezPararelPattern, List<GLatLng> l, 
            LatLng lkp, LatLng smallCoordinat1, Double smallL, Double bigL, String parrentID) {
        //super(browser);
