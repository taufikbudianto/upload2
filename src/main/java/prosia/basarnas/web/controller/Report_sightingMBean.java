...
@Scope("view")
public @Data
class Report_sightingMBean extends AbstractManagedBean {
 ...
 //           String jrxml = "/report/report_jasper/Report_sighting_hearing.jrxml";
            String jrxml = File.separator + "report" + File.separator + "report_jasper"+File.separator+"Report_sighting_hearing.jrxml";
