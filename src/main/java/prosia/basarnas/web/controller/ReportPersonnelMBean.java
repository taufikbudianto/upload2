...
public @Data
class ReportPersonnelMBean extends AbstractManagedBean implements InitializingBean {
...
//            String jrxml = "/report/report_jasper/Report_personnel.jrxml";
            String jrxml = File.separator + "report" + File.separator + "report_jasper" + File.separator + "Report_personnel.jrxml";
