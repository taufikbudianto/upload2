...
@Scope("view")
public @Data
class IncidentSRUDaratMBean extends AbstractManagedBean implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        String id = currIncident.getIncidentid();
        ...
        if (id != null) {
            ...
            if (currIncident.getLongitude() != null && currIncident.getLatitude() != null) {
                ...
                //resAssets=resAssetRepo.findSruNearestKansar("0", nearestKansar);
            ...
            System.out.println("RES ASSET : " + resAsset);
    ...
    private Specification<ResAsset> whereQuery() {
        ...
        return new Specification<ResAsset>() {
            ...
            public Predicate toPredicate(Root<ResAsset> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                predicates.add(cb.equal(root.<BigInteger>get("op_type"), BigInteger.valueOf(0))); //DARAT
    ...
    public void viewCheck(TempCheck tempcheck) {
        ...
        RequestContext.getCurrentInstance().reset("incidentdetail:incident-sru-tab:idviewsrudarat");
        RequestContext.getCurrentInstance().update("incidentdetail:incident-sru-tab:idviewsrudarat");
        RequestContext.getCurrentInstance().execute("PF('widgetViewSruDarat').show()");
    }
...
//                  incidentAsset.setModifiedBy();
        ...
        RequestContext.getCurrentInstance().execute("PF('widgetViewSruDarat').hide()");
...
//                  incidentAsset.setModifiedBy();
                    ...
                    incidentAssetRepo.save(incidentAsset);
                    addPopUpMessage("Sukses", "Incident Asset Darat berhasil disimpan dengan Asset : " + tempcheck.getResAsset().getName());
                }
            } else {
                IncidentAsset incAss = new IncidentAsset();
                incAss = incidentAssetRepo.findAllByIncidentAndAsset(inc, tempcheck.getResAsset());
                if (incAss != null) {
                    ...
                    addMessage("Sukses", "Incident Asset Darat berhasil didelete (" + tempcheck.getResAsset().getName() + " )");
                }
            }
        }
    }
