...
public @Data
class ReportAsetMBean extends AbstractManagedBean implements InitializingBean {

    private List<SelectItem> listKantorSar;

    private String ISSRU;
...
//            String jrxml = "/report/report_jasper/Report_asset.jrxml";
            String jrxml = File.separator + "report" + File.separator + "report_jasper" + File.separator + "Report_asset.jrxml";
...
//parameter atau field yang akan dijadikan 
