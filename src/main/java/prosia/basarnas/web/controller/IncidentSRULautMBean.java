...
@Scope("view")
public @Data
class IncidentSRULautMBean extends AbstractManagedBean implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (id != null) {
            ...
            if (currIncident.getLongitude() != null && currIncident.getLatitude() != null){
               ...
               //resAssets= resAssetRepo.findSruNearestKansar("2", nearestKansar);
    ...
    private Specification<ResAsset> whereQuery() {
        ...
        return new Specification<ResAsset>() {
            ...
            public Predicate toPredicate(Root<ResAsset> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                predicates.add(cb.equal(root.<BigInteger>get("op_type"), BigInteger.valueOf(2))); //LAUT
    ...
    public void viewCheck(TempCheck tempcheck) {
        ...
        RequestContext.getCurrentInstance().reset("incidentdetail:incident-sru-tab:idviewsrulaut");
        RequestContext.getCurrentInstance().update("incidentdetail:incident-sru-tab:idviewsrulaut");
        RequestContext.getCurrentInstance().execute("PF('widgetViewSruLaut').show()");
    }
...
//                  incidentAsset.setModifiedBy();
        ...
        //refresh();
        RequestContext.getCurrentInstance().execute("PF('widgetViewSruLaut').hide()");
...
//                  incidentAsset.setModifiedBy();
                    ...
                    incidentAssetRepo.save(incidentAsset);
                    addMessage("Sukses", "Incident Asset Laut berhasil disimpan dengan Asset : " + tempcheck.getResAsset().getName());
                }
//                }
            } else {
                IncidentAsset incAss = new IncidentAsset();
                ...
                if (incAss != null) {
                    ...
                    addMessage("Sukses", "Incident Asset Laut berhasil didelete (" + tempcheck.getResAsset().getName() + " )");
                }
            }
        }
    }
