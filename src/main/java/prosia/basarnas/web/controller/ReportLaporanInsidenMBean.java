...
public @Data
class ReportLaporanInsidenMBean extends AbstractManagedBean {
    ...
    public ReportLaporanInsidenMBean() {
        try {
...
//
    ...
    public void reportPrint() throws ParseException {
        try {
            ...
            String jrxml = File.separator + "report" + File.separator + "report_jasper" + File.separator + "laporanincident.jrxml";
