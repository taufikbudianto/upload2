 ...
 * @author Aris
 */
public class SimpleDateTimeZoneFormat extends SimpleDateFormat{
    ...
    public SimpleDateTimeZoneFormat(Locale locale) {
        super("dd/MM/yyyy", locale);
    }

    public SimpleDateTimeZoneFormat(String pattern) {
        this.applyPattern(pattern);
    }
    
    public SimpleDateTimeZoneFormat() {
    }
